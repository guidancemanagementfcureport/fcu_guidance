          ...
          child: Column(
            children: [
              ModernDashboardHeader(
                ...
                subtitle: 'Manage your teacher credentials and account preferences',
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppTheme.successGreen.withValues(alpha: 0.2), AppTheme.successGreen.withValues(alpha: 0.1)],
              ),
              shape: BoxShape.circle,
              border: Border.all(color: Colors.white, width: 4),
              boxShadow: [
                BoxShadow(color: AppTheme.successGreen.withValues(alpha: 0.1), blurRadius: 15, spreadRadius: 2),
              ],
            ...
            child: user.avatarUrl == null
                ? const Icon(Icons.person_rounded, color: AppTheme.successGreen, size: 70)
                : null,
          ),
          ...
          Container(
            ...
            child: Text(
              ...
              style: const TextStyle(color: AppTheme.successGreen, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 1),
            ),
          ),
          const SizedBox(height: 40),
          _buildQuickStat('Educator Since', DateFormat('MMM yyyy').format(user.createdAt)),
        ],
      ),
    ).fadeInSlideUp();
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoItem(Icons.business_rounded, 'Department', user.department ?? 'Faculty', AppTheme.successGreen),
          const Divider(height: 48),
          _buildInfoItem(Icons.verified_user_outlined, 'Account Status', user.isActive ? 'Active & Verified' : 'Standard', AppTheme.infoBlue),
          const Divider(height: 48),
          _buildInfoItem(Icons.login_rounded, 'Last Login Activity', user.lastLogin != null ? DateFormat('MMMM dd, yyyy • HH:mm').format(user.lastLogin!) : 'Recent session', AppTheme.paleBlue),
        ],
      ),
