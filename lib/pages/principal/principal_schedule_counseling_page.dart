...
class PrincipalScheduleCounselingPage extends StatefulWidget {
  final ReportModel report;

  const PrincipalScheduleCounselingPage({super.key, required this.report});

  @override
  State<PrincipalScheduleCounselingPage> createState() =>
      _PrincipalScheduleCounselingPageState();
}

class _PrincipalScheduleCounselingPageState
    extends State<PrincipalScheduleCounselingPage> {
