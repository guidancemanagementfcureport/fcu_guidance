...
class PrincipalApprovalDialog extends StatefulWidget {
  final ReportModel report;

  const PrincipalApprovalDialog({super.key, required this.report});

  @override
  State<PrincipalApprovalDialog> createState() => _PrincipalApprovalDialogState();
}

class _PrincipalApprovalDialogState extends State<PrincipalApprovalDialog> {
